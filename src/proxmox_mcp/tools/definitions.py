...
UPDATE_LXC_FEATURES_DESC = """Update LXC features (nesting/keyctl/fuse). keyctl/fuse beyond nesting usually need elevated role or root@pam — tool does not strip unsupported flags. After change: get_guest_pending + stop/start or reboot. Parameters: node*, vmid*, features*"""
